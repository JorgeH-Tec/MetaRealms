...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL) || strlen($email) > 100) {
        ...
        if (mysqli_stmt_num_rows($stmt) == 1) {
            ...
            $link_recuperacao = "http://localhost/Metarealms/nova_senha.php?token=$token";
...
<head>
    <meta charset="UTF-8">
    <title>MetaRealms - Recuperar Senha</title>
...
<header class="topo">
    <div class="logo"><a href="index.php">Virtual<span>Town</span></a></div>
</header>
