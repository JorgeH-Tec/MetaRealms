...
<head>
  ...
  <title>MetaRealms - Sobre o Projeto</title>
...
<?php include 'includes/navbar.php'; ?>
  ...
  <section class="cards-classes123">
    <div class="card-classe123">
        ...
        <p>O MetaRealms foi criado por um estudante apaixonado por tecnologia e inovação chamado Jorge. Unindo habilidades para aprimorar
           um jogo indie, pensado para evoluir e se adaptar às novas tecnologias que surgirem nos próximos anos. Meu objetivo é construir um universo vivo, que cresça junto com o avanço do mundo digital.</p>
    </div>
    <div class="card-classe123">
        <h2>Nossa Missão</h2>
        <p>No MetaRealms, desejo oferecer um espaço onde cada pessoa possa se expressar livremente, criar seus próprios personagens e explorar mundos cheios de possibilidades. O diferencial é desenvolver um jogo capaz de incorporar novas tendências tecnológicas ao longo do tempo, tornando a experiência sempre atual, criativa e surpreendente.</p>
    </div>
    <div class="card-classe123">
        <h2>Tecnologias Utilizadas</h2>
        <p>Este projeto foi desenvolvido utilizando HTML, CSS, JavaScript puro e PHP estruturado, integrados a um banco de dados MySQL para gerenciar usuários e suas informações. Também inclui efeitos visuais em JavaScript, como partículas e animações, para criar uma atmosfera mais imersiva. Além disso, desenvolvi pequenas demos interativas em JavaScript para apresentar algumas ideias do jogo enquanto ele está em desenvolvimento.</p>
    </div>
  </section>
...
<section class="cta">
  <div class="cta-conteudo">
    <h2>Tem algum feedback, quer me ajudar, trabalhar comigo?</h2>
    <p>Ficarei felizes em receber sua mensagem e trocar ideias.</p>
  <a href="https://mail.google.com/mail/?view=cm&fs=1&to=realidadevirtual.phpdt@gmail.com&su=Contato%20RV" target="_blank" class="btn-cta">Contate-me</a>
  </div>
</section>
